...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="checkSales.php">Check Sales</a>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="regCustomers.php">View Registered Customer</a>
          <a class="dropdown-item" href="viewShopping.php">View Shopping</a>
        </div>
      </li>
    </ul>
  </div>
