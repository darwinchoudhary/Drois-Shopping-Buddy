...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      ...
      <a class="nav-item nav-link" href="newOrder.php">New Orders</a>
      <a class="nav-item nav-link" href="currentOrder.php">Current Orders</a>
      <a class="nav-item nav-link" href="moneyEarned.php">Money Earned</a>
    </div>
